      ...
      <header className="bg-white border-b border-gray-100 sticky top-0 z-10">
        <div className="max-w-lg mx-auto px-4 py-4 space-y-3">
          <div className="flex items-center justify-between">
            ...
            <Link
              href="/for-stores"
              className="text-xs font-semibold text-amber-700 hover:text-amber-800 border border-amber-200 bg-amber-50 hover:bg-amber-100 px-3 py-1.5 rounded-full transition-colors shrink-0"
            >
              店舗様はこちら
            </Link>
          </div>
