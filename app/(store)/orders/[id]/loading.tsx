export default function Loading() {
  return (
    <div className="min-h-screen bg-stone-50 flex flex-col">
      ...
      <main id="main-content" aria-busy="true" aria-label="注文状況を読み込み中" className="max-w-lg mx-auto px-4 py-8 flex-1 space-y-6 w-full">
        ...
        <div className="h-12 bg-white border border-amber-200 rounded-xl animate-pulse" />
