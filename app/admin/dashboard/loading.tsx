export default function Loading() {
  return (
    <div className="min-h-screen bg-stone-50">
      ...
      <main id="main-content" aria-busy="true" aria-label="注文管理を読み込み中" className="max-w-4xl mx-auto px-4 py-4 space-y-4">
        {[1, 2, 3].map(i => (
          <div key={i} className="bg-white rounded-2xl shadow-sm border border-gray-100 p-5 space-y-3 animate-pulse">
