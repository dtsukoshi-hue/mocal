  ...
  return (
    <div className="min-h-screen bg-stone-50">
      ...
      <main id="main-content" aria-busy="true" aria-label="レポートを読み込み中" className="max-w-2xl mx-auto px-4 py-6 space-y-5">
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 h-10 animate-pulse" />
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-4 animate-pulse col-span-2">
